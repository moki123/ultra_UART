...
void SYS_Initialize ( void* data )
{
    ...
    IR_Initialize();
    /* Initialize Middleware */
    xQueue = createMessageQ();
    xQueue2 = createMessageQIR();
    xQueueTh = createMessageQThread();
    xQueueISR = createMessageQISR();
    UART_TRANSMIT_Queue =createUART_TRANSMIT_Queue();
    TRANSMIT_Queue = createTransmit_Queue();
